...
import { getApplications, processVerification, sortByRegion, sortByTime } from "@/lib/ktp-actions"
                ...
                <Card key={app.id} className="overflow-hidden">
                  ...
                  <CardContent className="pb-4">
                    ...
                    <div className="mt-4 flex justify-between">
                      ...
                      {app.status !== "verified" && (
                        <Button size="sm" onClick={() => handleVerify(app.id)} className="flex items-center gap-1">
